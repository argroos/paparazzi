 ...
 * @param _mz 
 */
static inline void pprzlink_msg_v2_send_IMU_MAG_RAW(struct pprzlink_msg * msg, uint8_t *_id, int32_t *_mx, int32_t *_my, int32_t *_mz) {
...
#define DOWNLINK_SEND_IMU_MAG_RAW(_trans, _dev, id, mx, my, mz) pprz_msg_send_IMU_MAG_RAW(&((_trans).trans_tx), &((_dev).device), AC_ID, id, mx, my, mz)
/**
 ...
 * @param _mz 
 */
static inline void pprz_msg_send_IMU_MAG_RAW(struct transport_tx *trans, struct link_device *dev, uint8_t ac_id, uint8_t *_id, int32_t *_mx, int32_t *_my, int32_t *_mz) {
    ...
    msg.receiver_id = 0;
    msg.component_id = 0;
    pprzlink_msg_v2_send_IMU_MAG_RAW(&msg,_id,_mx,_my,_mz);
}


#else // DOWNLINK

#define DOWNLINK_SEND_IMU_MAG_RAW(_trans, _dev, id, mx, my, mz) {}
static inline void pprz_send_msg_IMU_MAG_RAW(struct transport_tx *trans __attribute__((unused)), struct link_device *dev __attribute__((unused)), uint8_t ac_id __attribute__((unused)), uint8_t *_id __attribute__((unused)), int32_t *_mx __attribute__((unused)), int32_t *_my __attribute__((unused)), int32_t *_mz __attribute__((unused))) {}

#endif // DOWNLINK


/** Getter for field id in message IMU_MAG_RAW
  *
  * @param _payload : a pointer to the IMU_MAG_RAW message
  * @return 
  */
static inline uint8_t pprzlink_get_DL_IMU_MAG_RAW_id(uint8_t * _payload __attribute__((unused)))
{
...
#define DL_IMU_MAG_RAW_id(_payload) pprzlink_get_DL_IMU_MAG_RAW_id(_payload)
