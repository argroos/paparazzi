 ...
 * @param _temperature_dev Device temperature
 * @param _node_id Node ID
 * @param _motor_id Motor ID
 */
static inline void pprzlink_msg_v2_send_ESC(struct pprzlink_msg * msg, float *_amps, float *_bat_volts, float *_power, float *_rpm, float *_motor_volts, float *_energy, float *_temperature, float *_temperature_dev, uint8_t *_node_id, uint8_t *_motor_id) {
  ...
  if (msg->trans->check_available_space(msg, _FD_ADDR, size)) {
    ...
    msg->trans->put_bytes(msg, _FD, DL_TYPE_FLOAT, DL_FORMAT_SCALAR, (void *) _temperature_dev, 4);
    msg->trans->put_bytes(msg, _FD, DL_TYPE_UINT8, DL_FORMAT_SCALAR, (void *) _node_id, 1);
...
#define DOWNLINK_SEND_ESC(_trans, _dev, amps, bat_volts, power, rpm, motor_volts, energy, temperature, temperature_dev, node_id, motor_id) pprz_msg_send_ESC(&((_trans).trans_tx), &((_dev).device), AC_ID, amps, bat_volts, power, rpm, motor_volts, energy, temperature, temperature_dev, node_id, motor_id)
/**
 ...
 * @param _motor_id Motor ID
 */
static inline void pprz_msg_send_ESC(struct transport_tx *trans, struct link_device *dev, uint8_t ac_id, float *_amps, float *_bat_volts, float *_power, float *_rpm, float *_motor_volts, float *_energy, float *_temperature, float *_temperature_dev, uint8_t *_node_id, uint8_t *_motor_id) {
    ...
    msg.receiver_id = 0;
    msg.component_id = 0;
    pprzlink_msg_v2_send_ESC(&msg,_amps,_bat_volts,_power,_rpm,_motor_volts,_energy,_temperature,_temperature_dev,_node_id,_motor_id);
}


#else // DOWNLINK

#define DOWNLINK_SEND_ESC(_trans, _dev, amps, bat_volts, power, rpm, motor_volts, energy, temperature, temperature_dev, node_id, motor_id) {}
static inline void pprz_send_msg_ESC(struct transport_tx *trans __attribute__((unused)), struct link_device *dev __attribute__((unused)), uint8_t ac_id __attribute__((unused)), float *_amps __attribute__((unused)), float *_bat_volts __attribute__((unused)), float *_power __attribute__((unused)), float *_rpm __attribute__((unused)), float *_motor_volts __attribute__((unused)), float *_energy __attribute__((unused)), float *_temperature __attribute__((unused)), float *_temperature_dev __attribute__((unused)), uint8_t *_node_id __attribute__((unused)), uint8_t *_motor_id __attribute__((unused))) {}
...
/** Getter for field temperature in message ESC
  *
  * @param _payload : a pointer to the ESC message
  * @return Temperature
  */
static inline float pprzlink_get_DL_ESC_temperature(uint8_t * _payload __attribute__((unused)))
{
    return _PPRZ_VAL_float(_payload, 28);
}


/** Getter for field temperature_dev in message ESC
  *
  * @param _payload : a pointer to the ESC message
  * @return Device temperature
  */
static inline float pprzlink_get_DL_ESC_temperature_dev(uint8_t * _payload __attribute__((unused)))
{
    return _PPRZ_VAL_float(_payload, 32);
}


/** Getter for field node_id in message ESC
  *
  * @param _payload : a pointer to the ESC message
  * @return Node ID
  */
static inline uint8_t pprzlink_get_DL_ESC_node_id(uint8_t * _payload __attribute__((unused)))
{
...
#define DL_ESC_temperature(_payload) pprzlink_get_DL_ESC_temperature(_payload)
#define DL_ESC_temperature_dev(_payload) pprzlink_get_DL_ESC_temperature_dev(_payload)
#define DL_ESC_node_id(_payload) pprzlink_get_DL_ESC_node_id(_payload)
