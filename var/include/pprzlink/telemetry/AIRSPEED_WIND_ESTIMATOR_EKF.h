...
#define DL_AIRSPEED_WIND_ESTIMATOR_EKF 196
#define PPRZ_MSG_ID_AIRSPEED_WIND_ESTIMATOR_EKF 196
 ...
 * @param _healthy 
 * @param _crashes_n 
 * @param _innov_V_gnd_x 
 * @param _innov_V_gnd_y 
 * @param _innov_V_gnd_z 
 * @param _innov_acc_x 
 * @param _innov_acc_y 
 * @param _innov_acc_z 
 * @param _innov_V_pitot 
 * @param _debug_1 
 * @param _debug_2 
 * @param _debug_3 
 */
static inline void pprzlink_msg_v2_send_AIRSPEED_WIND_ESTIMATOR_EKF(struct pprzlink_msg * msg, float *_u_est, float *_v_est, float *_w_est, float *_mu_N, float *_mu_E, float *_mu_D, float *_offset_x, float *_offset_y, float *_offset_z, uint8_t *_healthy, uint16_t *_crashes_n, float *_innov_V_gnd_x, float *_innov_V_gnd_y, float *_innov_V_gnd_z, float *_innov_acc_x, float *_innov_acc_y, float *_innov_acc_z, float *_innov_V_pitot, float *_debug_1, float *_debug_2, float *_debug_3) {
#if PPRZLINK_ENABLE_FD
  long _FD = 0; /* can be an address, an index, a file descriptor, ... */
#endif
  const uint8_t size = msg->trans->size_of(msg, /* msg header overhead */4+4+4+4+4+4+4+4+4+4+1+2+4+4+4+4+4+4+4+4+4+4);
  if (msg->trans->check_available_space(msg, _FD_ADDR, size)) {
    msg->trans->count_bytes(msg, size);
    msg->trans->start_message(msg, _FD, /* msg header overhead */4+4+4+4+4+4+4+4+4+4+1+2+4+4+4+4+4+4+4+4+4+4);
    ...
    msg->trans->put_bytes(msg, _FD, DL_TYPE_FLOAT, DL_FORMAT_SCALAR, (void *) _innov_V_gnd_x, 4);
    msg->trans->put_bytes(msg, _FD, DL_TYPE_FLOAT, DL_FORMAT_SCALAR, (void *) _innov_V_gnd_y, 4);
    msg->trans->put_bytes(msg, _FD, DL_TYPE_FLOAT, DL_FORMAT_SCALAR, (void *) _innov_V_gnd_z, 4);
    msg->trans->put_bytes(msg, _FD, DL_TYPE_FLOAT, DL_FORMAT_SCALAR, (void *) _innov_acc_x, 4);
    msg->trans->put_bytes(msg, _FD, DL_TYPE_FLOAT, DL_FORMAT_SCALAR, (void *) _innov_acc_y, 4);
    msg->trans->put_bytes(msg, _FD, DL_TYPE_FLOAT, DL_FORMAT_SCALAR, (void *) _innov_acc_z, 4);
    msg->trans->put_bytes(msg, _FD, DL_TYPE_FLOAT, DL_FORMAT_SCALAR, (void *) _innov_V_pitot, 4);
...
#define DOWNLINK_SEND_AIRSPEED_WIND_ESTIMATOR_EKF(_trans, _dev, u_est, v_est, w_est, mu_N, mu_E, mu_D, offset_x, offset_y, offset_z, healthy, crashes_n, innov_V_gnd_x, innov_V_gnd_y, innov_V_gnd_z, innov_acc_x, innov_acc_y, innov_acc_z, innov_V_pitot, debug_1, debug_2, debug_3) pprz_msg_send_AIRSPEED_WIND_ESTIMATOR_EKF(&((_trans).trans_tx), &((_dev).device), AC_ID, u_est, v_est, w_est, mu_N, mu_E, mu_D, offset_x, offset_y, offset_z, healthy, crashes_n, innov_V_gnd_x, innov_V_gnd_y, innov_V_gnd_z, innov_acc_x, innov_acc_y, innov_acc_z, innov_V_pitot, debug_1, debug_2, debug_3)
/**
...
static inline void pprz_msg_send_AIRSPEED_WIND_ESTIMATOR_EKF(struct transport_tx *trans, struct link_device *dev, uint8_t ac_id, float *_u_est, float *_v_est, float *_w_est, float *_mu_N, float *_mu_E, float *_mu_D, float *_offset_x, float *_offset_y, float *_offset_z, uint8_t *_healthy, uint16_t *_crashes_n, float *_innov_V_gnd_x, float *_innov_V_gnd_y, float *_innov_V_gnd_z, float *_innov_acc_x, float *_innov_acc_y, float *_innov_acc_z, float *_innov_V_pitot, float *_debug_1, float *_debug_2, float *_debug_3) {
    ...
    msg.receiver_id = 0;
    msg.component_id = 0;
    pprzlink_msg_v2_send_AIRSPEED_WIND_ESTIMATOR_EKF(&msg,_u_est,_v_est,_w_est,_mu_N,_mu_E,_mu_D,_offset_x,_offset_y,_offset_z,_healthy,_crashes_n,_innov_V_gnd_x,_innov_V_gnd_y,_innov_V_gnd_z,_innov_acc_x,_innov_acc_y,_innov_acc_z,_innov_V_pitot,_debug_1,_debug_2,_debug_3);
}


#else // DOWNLINK

#define DOWNLINK_SEND_AIRSPEED_WIND_ESTIMATOR_EKF(_trans, _dev, u_est, v_est, w_est, mu_N, mu_E, mu_D, offset_x, offset_y, offset_z, healthy, crashes_n, innov_V_gnd_x, innov_V_gnd_y, innov_V_gnd_z, innov_acc_x, innov_acc_y, innov_acc_z, innov_V_pitot, debug_1, debug_2, debug_3) {}
static inline void pprz_send_msg_AIRSPEED_WIND_ESTIMATOR_EKF(struct transport_tx *trans __attribute__((unused)), struct link_device *dev __attribute__((unused)), uint8_t ac_id __attribute__((unused)), float *_u_est __attribute__((unused)), float *_v_est __attribute__((unused)), float *_w_est __attribute__((unused)), float *_mu_N __attribute__((unused)), float *_mu_E __attribute__((unused)), float *_mu_D __attribute__((unused)), float *_offset_x __attribute__((unused)), float *_offset_y __attribute__((unused)), float *_offset_z __attribute__((unused)), uint8_t *_healthy __attribute__((unused)), uint16_t *_crashes_n __attribute__((unused)), float *_innov_V_gnd_x __attribute__((unused)), float *_innov_V_gnd_y __attribute__((unused)), float *_innov_V_gnd_z __attribute__((unused)), float *_innov_acc_x __attribute__((unused)), float *_innov_acc_y __attribute__((unused)), float *_innov_acc_z __attribute__((unused)), float *_innov_V_pitot __attribute__((unused)), float *_debug_1 __attribute__((unused)), float *_debug_2 __attribute__((unused)), float *_debug_3 __attribute__((unused))) {}
...
/** Getter for field innov_V_gnd_x in message AIRSPEED_WIND_ESTIMATOR_EKF
  *
  * @param _payload : a pointer to the AIRSPEED_WIND_ESTIMATOR_EKF message
  * @return 
  */
static inline float pprzlink_get_DL_AIRSPEED_WIND_ESTIMATOR_EKF_innov_V_gnd_x(uint8_t * _payload __attribute__((unused)))
{
    return _PPRZ_VAL_float(_payload, 43);
}


/** Getter for field innov_V_gnd_y in message AIRSPEED_WIND_ESTIMATOR_EKF
  *
  * @param _payload : a pointer to the AIRSPEED_WIND_ESTIMATOR_EKF message
  * @return 
  */
static inline float pprzlink_get_DL_AIRSPEED_WIND_ESTIMATOR_EKF_innov_V_gnd_y(uint8_t * _payload __attribute__((unused)))
{
    return _PPRZ_VAL_float(_payload, 47);
}


/** Getter for field innov_V_gnd_z in message AIRSPEED_WIND_ESTIMATOR_EKF
  *
  * @param _payload : a pointer to the AIRSPEED_WIND_ESTIMATOR_EKF message
  * @return 
  */
static inline float pprzlink_get_DL_AIRSPEED_WIND_ESTIMATOR_EKF_innov_V_gnd_z(uint8_t * _payload __attribute__((unused)))
{
    return _PPRZ_VAL_float(_payload, 51);
}


/** Getter for field innov_acc_x in message AIRSPEED_WIND_ESTIMATOR_EKF
  *
  * @param _payload : a pointer to the AIRSPEED_WIND_ESTIMATOR_EKF message
  * @return 
  */
static inline float pprzlink_get_DL_AIRSPEED_WIND_ESTIMATOR_EKF_innov_acc_x(uint8_t * _payload __attribute__((unused)))
{
    return _PPRZ_VAL_float(_payload, 55);
}


/** Getter for field innov_acc_y in message AIRSPEED_WIND_ESTIMATOR_EKF
  *
  * @param _payload : a pointer to the AIRSPEED_WIND_ESTIMATOR_EKF message
  * @return 
  */
static inline float pprzlink_get_DL_AIRSPEED_WIND_ESTIMATOR_EKF_innov_acc_y(uint8_t * _payload __attribute__((unused)))
{
    return _PPRZ_VAL_float(_payload, 59);
}


/** Getter for field innov_acc_z in message AIRSPEED_WIND_ESTIMATOR_EKF
  *
  * @param _payload : a pointer to the AIRSPEED_WIND_ESTIMATOR_EKF message
  * @return 
  */
static inline float pprzlink_get_DL_AIRSPEED_WIND_ESTIMATOR_EKF_innov_acc_z(uint8_t * _payload __attribute__((unused)))
{
    return _PPRZ_VAL_float(_payload, 63);
}


/** Getter for field innov_V_pitot in message AIRSPEED_WIND_ESTIMATOR_EKF
  *
  * @param _payload : a pointer to the AIRSPEED_WIND_ESTIMATOR_EKF message
  * @return 
  */
static inline float pprzlink_get_DL_AIRSPEED_WIND_ESTIMATOR_EKF_innov_V_pitot(uint8_t * _payload __attribute__((unused)))
{
    return _PPRZ_VAL_float(_payload, 67);
}
...
{
    return _PPRZ_VAL_float(_payload, 71);
}
...
{
    return _PPRZ_VAL_float(_payload, 75);
}
...
{
    return _PPRZ_VAL_float(_payload, 79);
}
...
#define DL_AIRSPEED_WIND_ESTIMATOR_EKF_innov_V_gnd_x(_payload) pprzlink_get_DL_AIRSPEED_WIND_ESTIMATOR_EKF_innov_V_gnd_x(_payload)
#define DL_AIRSPEED_WIND_ESTIMATOR_EKF_innov_V_gnd_y(_payload) pprzlink_get_DL_AIRSPEED_WIND_ESTIMATOR_EKF_innov_V_gnd_y(_payload)
#define DL_AIRSPEED_WIND_ESTIMATOR_EKF_innov_V_gnd_z(_payload) pprzlink_get_DL_AIRSPEED_WIND_ESTIMATOR_EKF_innov_V_gnd_z(_payload)
#define DL_AIRSPEED_WIND_ESTIMATOR_EKF_innov_acc_x(_payload) pprzlink_get_DL_AIRSPEED_WIND_ESTIMATOR_EKF_innov_acc_x(_payload)
#define DL_AIRSPEED_WIND_ESTIMATOR_EKF_innov_acc_y(_payload) pprzlink_get_DL_AIRSPEED_WIND_ESTIMATOR_EKF_innov_acc_y(_payload)
#define DL_AIRSPEED_WIND_ESTIMATOR_EKF_innov_acc_z(_payload) pprzlink_get_DL_AIRSPEED_WIND_ESTIMATOR_EKF_innov_acc_z(_payload)
#define DL_AIRSPEED_WIND_ESTIMATOR_EKF_innov_V_pitot(_payload) pprzlink_get_DL_AIRSPEED_WIND_ESTIMATOR_EKF_innov_V_pitot(_payload)
