 ...
 * @param _front_divergence  divergence from front cam 
 */
static inline void pprzlink_msg_v2_send_DIVERGENCE(struct pprzlink_msg * msg, float *_divergence, float *_divergence_vision, float *_normalized_thrust, float *_cov_div, float *_pstate, float *_pused, float *_sonar, float *_front_divergence) {
  ...
  if (msg->trans->check_available_space(msg, _FD_ADDR, size)) {
    ...
    msg->trans->put_bytes(msg, _FD, DL_TYPE_FLOAT, DL_FORMAT_SCALAR, (void *) _front_divergence, 4);
...
#define DOWNLINK_SEND_DIVERGENCE(_trans, _dev, divergence, divergence_vision, normalized_thrust, cov_div, pstate, pused, sonar, front_divergence) pprz_msg_send_DIVERGENCE(&((_trans).trans_tx), &((_dev).device), AC_ID, divergence, divergence_vision, normalized_thrust, cov_div, pstate, pused, sonar, front_divergence)
/**
 ...
 * @param _front_divergence  divergence from front cam 
 */
static inline void pprz_msg_send_DIVERGENCE(struct transport_tx *trans, struct link_device *dev, uint8_t ac_id, float *_divergence, float *_divergence_vision, float *_normalized_thrust, float *_cov_div, float *_pstate, float *_pused, float *_sonar, float *_front_divergence) {
    ...
    msg.receiver_id = 0;
    msg.component_id = 0;
    pprzlink_msg_v2_send_DIVERGENCE(&msg,_divergence,_divergence_vision,_normalized_thrust,_cov_div,_pstate,_pused,_sonar,_front_divergence);
}


#else // DOWNLINK

#define DOWNLINK_SEND_DIVERGENCE(_trans, _dev, divergence, divergence_vision, normalized_thrust, cov_div, pstate, pused, sonar, front_divergence) {}
static inline void pprz_send_msg_DIVERGENCE(struct transport_tx *trans __attribute__((unused)), struct link_device *dev __attribute__((unused)), uint8_t ac_id __attribute__((unused)), float *_divergence __attribute__((unused)), float *_divergence_vision __attribute__((unused)), float *_normalized_thrust __attribute__((unused)), float *_cov_div __attribute__((unused)), float *_pstate __attribute__((unused)), float *_pused __attribute__((unused)), float *_sonar __attribute__((unused)), float *_front_divergence __attribute__((unused))) {}
...
/** Getter for field front_divergence in message DIVERGENCE
  *
  * @param _payload : a pointer to the DIVERGENCE message
  * @return  divergence from front cam 
  */
static inline float pprzlink_get_DL_DIVERGENCE_front_divergence(uint8_t * _payload __attribute__((unused)))
{
...
#define DL_DIVERGENCE_front_divergence(_payload) pprzlink_get_DL_DIVERGENCE_front_divergence(_payload)
