 ...
 */
static inline void pprzlink_msg_v2_send_IMU_MAG_CURRENT_CALIBRATION(struct pprzlink_msg * msg, uint8_t *_id, int32_t *_mx, int32_t *_my, int32_t *_mz, float *_electrical_current) {
  ...
  if (msg->trans->check_available_space(msg, _FD_ADDR, size)) {
    ...
    msg->trans->put_bytes(msg, _FD, DL_TYPE_FLOAT, DL_FORMAT_SCALAR, (void *) _electrical_current, 4);
...
#define DOWNLINK_SEND_IMU_MAG_CURRENT_CALIBRATION(_trans, _dev, id, mx, my, mz, electrical_current) pprz_msg_send_IMU_MAG_CURRENT_CALIBRATION(&((_trans).trans_tx), &((_dev).device), AC_ID, id, mx, my, mz, electrical_current)
/**
 ...
 * @param _electrical_current 
 */
static inline void pprz_msg_send_IMU_MAG_CURRENT_CALIBRATION(struct transport_tx *trans, struct link_device *dev, uint8_t ac_id, uint8_t *_id, int32_t *_mx, int32_t *_my, int32_t *_mz, float *_electrical_current) {
    ...
    msg.receiver_id = 0;
    msg.component_id = 0;
    pprzlink_msg_v2_send_IMU_MAG_CURRENT_CALIBRATION(&msg,_id,_mx,_my,_mz,_electrical_current);
}


#else // DOWNLINK

#define DOWNLINK_SEND_IMU_MAG_CURRENT_CALIBRATION(_trans, _dev, id, mx, my, mz, electrical_current) {}
static inline void pprz_send_msg_IMU_MAG_CURRENT_CALIBRATION(struct transport_tx *trans __attribute__((unused)), struct link_device *dev __attribute__((unused)), uint8_t ac_id __attribute__((unused)), uint8_t *_id __attribute__((unused)), int32_t *_mx __attribute__((unused)), int32_t *_my __attribute__((unused)), int32_t *_mz __attribute__((unused)), float *_electrical_current __attribute__((unused))) {}

#endif // DOWNLINK


/** Getter for field id in message IMU_MAG_CURRENT_CALIBRATION
  *
  * @param _payload : a pointer to the IMU_MAG_CURRENT_CALIBRATION message
  * @return 
  */
static inline uint8_t pprzlink_get_DL_IMU_MAG_CURRENT_CALIBRATION_id(uint8_t * _payload __attribute__((unused)))
{
...
/** Getter for field electrical_current in message IMU_MAG_CURRENT_CALIBRATION
  ...
  * @return 
  */
static inline float pprzlink_get_DL_IMU_MAG_CURRENT_CALIBRATION_electrical_current(uint8_t * _payload __attribute__((unused)))
{
...
#define DL_IMU_MAG_CURRENT_CALIBRATION_id(_payload) pprzlink_get_DL_IMU_MAG_CURRENT_CALIBRATION_id(_payload)
