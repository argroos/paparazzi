...
static inline void pprzlink_msg_v2_send_ROTORCRAFT_STATUS(struct pprzlink_msg * msg, uint32_t *_link_imu_nb_err, uint8_t *_motor_nb_err, uint8_t *_rc_status, uint8_t *_frame_rate, uint8_t *_gps_status, uint8_t *_ap_mode, uint8_t *_ap_in_flight, uint8_t *_ap_motors_on, uint8_t *_arming_status, uint8_t *_ap_h_mode, uint8_t *_ap_v_mode, uint16_t *_cpu_time, float *_vsupply, float *_vboard) {
  ...
  if (msg->trans->check_available_space(msg, _FD_ADDR, size)) {
    ...
    msg->trans->put_bytes(msg, _FD, DL_TYPE_FLOAT, DL_FORMAT_SCALAR, (void *) _vboard, 4);
...
#define DOWNLINK_SEND_ROTORCRAFT_STATUS(_trans, _dev, link_imu_nb_err, motor_nb_err, rc_status, frame_rate, gps_status, ap_mode, ap_in_flight, ap_motors_on, arming_status, ap_h_mode, ap_v_mode, cpu_time, vsupply, vboard) pprz_msg_send_ROTORCRAFT_STATUS(&((_trans).trans_tx), &((_dev).device), AC_ID, link_imu_nb_err, motor_nb_err, rc_status, frame_rate, gps_status, ap_mode, ap_in_flight, ap_motors_on, arming_status, ap_h_mode, ap_v_mode, cpu_time, vsupply, vboard)
/**
...
static inline void pprz_msg_send_ROTORCRAFT_STATUS(struct transport_tx *trans, struct link_device *dev, uint8_t ac_id, uint32_t *_link_imu_nb_err, uint8_t *_motor_nb_err, uint8_t *_rc_status, uint8_t *_frame_rate, uint8_t *_gps_status, uint8_t *_ap_mode, uint8_t *_ap_in_flight, uint8_t *_ap_motors_on, uint8_t *_arming_status, uint8_t *_ap_h_mode, uint8_t *_ap_v_mode, uint16_t *_cpu_time, float *_vsupply, float *_vboard) {
    ...
    msg.receiver_id = 0;
    msg.component_id = 0;
    pprzlink_msg_v2_send_ROTORCRAFT_STATUS(&msg,_link_imu_nb_err,_motor_nb_err,_rc_status,_frame_rate,_gps_status,_ap_mode,_ap_in_flight,_ap_motors_on,_arming_status,_ap_h_mode,_ap_v_mode,_cpu_time,_vsupply,_vboard);
}


#else // DOWNLINK

#define DOWNLINK_SEND_ROTORCRAFT_STATUS(_trans, _dev, link_imu_nb_err, motor_nb_err, rc_status, frame_rate, gps_status, ap_mode, ap_in_flight, ap_motors_on, arming_status, ap_h_mode, ap_v_mode, cpu_time, vsupply, vboard) {}
static inline void pprz_send_msg_ROTORCRAFT_STATUS(struct transport_tx *trans __attribute__((unused)), struct link_device *dev __attribute__((unused)), uint8_t ac_id __attribute__((unused)), uint32_t *_link_imu_nb_err __attribute__((unused)), uint8_t *_motor_nb_err __attribute__((unused)), uint8_t *_rc_status __attribute__((unused)), uint8_t *_frame_rate __attribute__((unused)), uint8_t *_gps_status __attribute__((unused)), uint8_t *_ap_mode __attribute__((unused)), uint8_t *_ap_in_flight __attribute__((unused)), uint8_t *_ap_motors_on __attribute__((unused)), uint8_t *_arming_status __attribute__((unused)), uint8_t *_ap_h_mode __attribute__((unused)), uint8_t *_ap_v_mode __attribute__((unused)), uint16_t *_cpu_time __attribute__((unused)), float *_vsupply __attribute__((unused)), float *_vboard __attribute__((unused))) {}
...
/** Getter for field vboard in message ROTORCRAFT_STATUS
  *
  * @param _payload : a pointer to the ROTORCRAFT_STATUS message
  * @return AP Board voltage
  */
static inline float pprzlink_get_DL_ROTORCRAFT_STATUS_vboard(uint8_t * _payload __attribute__((unused)))
{
...
#define DL_ROTORCRAFT_STATUS_vboard(_payload) pprzlink_get_DL_ROTORCRAFT_STATUS_vboard(_payload)
