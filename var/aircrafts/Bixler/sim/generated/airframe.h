/* This file has been generated from /home/argroos/paparazzi/conf/airframes/examples/bixler_lisa_m_2.xml */
...
#define AC_ID 2
#define MD5SUM ((uint8_t*)"\163\152\306\271\120\130\242\046\350\017\201\126\026\273\006\161")

#define SERVOS_DEFAULT_NB 6
#include "modules/actuators/actuators_default.h"

#define SERVO_THROTTLE_DRIVER_NO 1
#define SERVO_THROTTLE_IDX 0
...
#define SERVO_ELEVATOR_DRIVER_NO 2
#define SERVO_ELEVATOR_IDX 1
...
#define SERVO_RUDDER_DRIVER_NO 3
#define SERVO_RUDDER_IDX 2
...
#define SERVO_AILERON_RIGHT_DRIVER_NO 4
...
#define SERVO_AILERON_LEFT_DRIVER_NO 5
#define SERVO_AILERON_LEFT_IDX 4
...
static inline int get_servo_min(int _idx) {
  switch (_idx) {
    case SERVO_THROTTLE_DRIVER_NO: return SERVO_THROTTLE_MIN;
    case SERVO_ELEVATOR_DRIVER_NO: return SERVO_ELEVATOR_MIN;
    case SERVO_RUDDER_DRIVER_NO: return SERVO_RUDDER_MIN;
    case SERVO_AILERON_RIGHT_DRIVER_NO: return SERVO_AILERON_RIGHT_MIN;
    case SERVO_AILERON_LEFT_DRIVER_NO: return SERVO_AILERON_LEFT_MIN;
    default: return 0;
  };
}
...
static inline int get_servo_max(int _idx) {
  switch (_idx) {
    case SERVO_THROTTLE_DRIVER_NO: return SERVO_THROTTLE_MAX;
    case SERVO_ELEVATOR_DRIVER_NO: return SERVO_ELEVATOR_MAX;
    case SERVO_RUDDER_DRIVER_NO: return SERVO_RUDDER_MAX;
    case SERVO_AILERON_RIGHT_DRIVER_NO: return SERVO_AILERON_RIGHT_MAX;
    case SERVO_AILERON_LEFT_DRIVER_NO: return SERVO_AILERON_LEFT_MAX;
    default: return 0;
  };
}
...
static inline int get_servo_idx(int _idx) {
  switch (_idx) {
    case SERVO_THROTTLE_DRIVER_NO: return SERVO_THROTTLE_IDX;
    case SERVO_ELEVATOR_DRIVER_NO: return SERVO_ELEVATOR_IDX;
    case SERVO_RUDDER_DRIVER_NO: return SERVO_RUDDER_IDX;
    case SERVO_AILERON_RIGHT_DRIVER_NO: return SERVO_AILERON_RIGHT_IDX;
    case SERVO_AILERON_LEFT_DRIVER_NO: return SERVO_AILERON_LEFT_IDX;
    default: return 0;
  };
}
...
#define COMMANDS_NB_REAL 4
#define COMMANDS_NB 4
#define COMMAND_NAMES { "THROTTLE", "ROLL", "PITCH", "YAW" }
...
#define Set_RUDDER_Servo(_v) { \
  actuators[SERVO_RUDDER_IDX] = Clip(_v, SERVO_RUDDER_MIN, SERVO_RUDDER_MAX); \
  ActuatorDefaultSet(SERVO_RUDDER_DRIVER_NO, actuators[SERVO_RUDDER_IDX]); \
}

#define Set_AILERON_RIGHT_Servo(_v) { \
  actuators[SERVO_AILERON_RIGHT_IDX] = Clip(_v, SERVO_AILERON_RIGHT_MIN, SERVO_AILERON_RIGHT_MAX); \
  ActuatorDefaultSet(SERVO_AILERON_RIGHT_DRIVER_NO, actuators[SERVO_AILERON_RIGHT_IDX]); \
}

#define Set_THROTTLE_Servo(_v) { \
  actuators[SERVO_THROTTLE_IDX] = Clip(_v, SERVO_THROTTLE_MIN, SERVO_THROTTLE_MAX); \
  ActuatorDefaultSet(SERVO_THROTTLE_DRIVER_NO, actuators[SERVO_THROTTLE_IDX]); \
}

#define Set_AILERON_LEFT_Servo(_v) { \
  actuators[SERVO_AILERON_LEFT_IDX] = Clip(_v, SERVO_AILERON_LEFT_MIN, SERVO_AILERON_LEFT_MAX); \
  ActuatorDefaultSet(SERVO_AILERON_LEFT_DRIVER_NO, actuators[SERVO_AILERON_LEFT_IDX]); \
}

#define Set_ELEVATOR_Servo(_v) { \
  actuators[SERVO_ELEVATOR_IDX] = Clip(_v, SERVO_ELEVATOR_MIN, SERVO_ELEVATOR_MAX); \
  ActuatorDefaultSet(SERVO_ELEVATOR_DRIVER_NO, actuators[SERVO_ELEVATOR_IDX]); \
}
...
#define NPS_JSBSIM_LAUNCHSPEED 15
#define NPS_JSBSIM_MODEL "easystar"
#define NPS_JS_AXIS_THROTTLE 0
#define NPS_JS_AXIS_THROTTLE_REVERSED 1
#define NPS_JS_AXIS_ROLL 1
#define NPS_JS_AXIS_PITCH 2
#define NPS_JS_AXIS_PITCH_REVERSED 1
#define NPS_JS_AXIS_YAW 3
#define NPS_JS_AXIS_YAW_REVERSED 1
#define NPS_JS_AXIS_FLAPS 5
#define NPS_JS_AXIS_MODE 7
