...
#define PRESCALER_2 (uint32_t)(MODULES_FREQUENCY * (0.250000f))
...
#define PRESCALER_7 (uint32_t)(MODULES_FREQUENCY * (1.f / (CONTROL_FREQUENCY)))
#define PRESCALER_8 (uint32_t)(MODULES_FREQUENCY * (1.f / (NAVIGATION_FREQUENCY)))
...
static inline void modules_core_periodic_task(void) {
  ...
  if (i5 == (uint32_t)(0.700000f * PRESCALER_5)) {
    electrical_periodic();
  }
}
...
static inline void modules_sensors_periodic_task(void) {
  ...
  if (i2 == (uint32_t)(0.600000f * PRESCALER_2) && gps_ubx_ucenter_gps_ubx_ucenter_periodic_status == MODULES_RUN) {
    gps_ubx_ucenter_periodic();
  }
  if (i3 == (uint32_t)(0.000000f * PRESCALER_3) && gps_ublox_gps_ubx_periodic_check_status == MODULES_RUN) {
...
static inline void modules_control_periodic_task(void) {
  ...
  if (i7 == (uint32_t)(0.400000f * PRESCALER_7)) {
