...
#define TRISONICA_REPORT_PERIOD (0.200000f)
#define TRISONICA_REPORT_FREQ (5.000000f)
...
#define MAG_LIS3MDL_REPORT_PERIOD (0.100000f)
#define MAG_LIS3MDL_REPORT_FREQ (10.000000f)
#define MAG_LIS3MDL_MODULE_PERIODIC_PERIOD (0.016667f)
#define MAG_LIS3MDL_MODULE_PERIODIC_FREQ (60.000000f)
...
#define PRESCALER_7 (uint32_t)(MODULES_FREQUENCY * (0.200000f))
#define PRESCALER_8 (uint32_t)(MODULES_FREQUENCY * (0.020000f))
#define PRESCALER_9 (uint32_t)(MODULES_FREQUENCY * (1.f / (CONTROL_FREQUENCY)))
#define PRESCALER_10 (uint32_t)(MODULES_FREQUENCY * (1.f / (NAVIGATION_FREQUENCY)))
#define PRESCALER_11 (uint32_t)(MODULES_FREQUENCY * (0.016667f))

EXTERN_MODULES uint8_t trisonica_trisonica_report_status;
...
EXTERN_MODULES uint8_t mag_lis3mdl_mag_lis3mdl_report_status;
...
static inline void modules_sensors_init(void) {
  ...
  mag_lis3mdl_mag_lis3mdl_report_status = MODULES_STOP;
}
...
static inline void modules_default_init(void) {
  ...
  humid_sht_init();
  trisonica_init();
  trisonica_trisonica_report_status = MODULES_START;
}
...
static inline void modules_core_periodic_task(void) {
  ...
  if (i8 == (uint32_t)(0.000000f * PRESCALER_8)) {
    LED_PERIODIC();
  }
...
static inline void modules_sensors_periodic_task(void) {
  ...
  static uint32_t i6; i6++; if (i6>=PRESCALER_6) i6=0;
  static uint32_t i11; i11++; if (i11>=PRESCALER_11) i11=0;
  ...
  if (mag_lis3mdl_mag_lis3mdl_report_status == MODULES_START) {
    mag_lis3mdl_mag_lis3mdl_report_status = MODULES_RUN;
  }
  if (mag_lis3mdl_mag_lis3mdl_report_status == MODULES_STOP) {
    mag_lis3mdl_mag_lis3mdl_report_status = MODULES_IDLE;
  }

  if (i11 == (uint32_t)(0.000000f * PRESCALER_11)) {
    mag_lis3mdl_module_periodic();
  }
  if (i6 == (uint32_t)(0.900000f * PRESCALER_6) && mag_lis3mdl_mag_lis3mdl_report_status == MODULES_RUN) {
    mag_lis3mdl_report();
  }
  if (i3 == (uint32_t)(0.800000f * PRESCALER_3) && gps_ubx_ucenter_gps_ubx_ucenter_periodic_status == MODULES_RUN) {
    gps_ubx_ucenter_periodic();
  }
  if (i4 == (uint32_t)(0.200000f * PRESCALER_4) && gps_ublox_gps_ubx_periodic_check_status == MODULES_RUN) {
...
static inline void modules_control_periodic_task(void) {
  ...
  static uint32_t i10; i10++; if (i10>=PRESCALER_10) i10=0;
  ...
  if (i10 == (uint32_t)(0.700000f * PRESCALER_10)) {
...
static inline void modules_default_periodic_task(void) {
  ...
  if (trisonica_trisonica_report_status == MODULES_START) {
    trisonica_trisonica_report_status = MODULES_RUN;
  }
  if (trisonica_trisonica_report_status == MODULES_STOP) {
    trisonica_trisonica_report_status = MODULES_IDLE;
  }

  if (i1 == (uint32_t)(0.100000f * PRESCALER_1)) {
    temod_periodic();
  }
  if (i7 == (uint32_t)(0.900000f * PRESCALER_7) && trisonica_trisonica_report_status == MODULES_RUN) {
    trisonica_report();
  }
