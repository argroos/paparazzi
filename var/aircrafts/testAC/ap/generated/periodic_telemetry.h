...
#define TELEMETRY_PPRZ_MSG_AEROPROBE_IDX 8
#define TELEMETRY_PPRZ_MSG_ADC_GENERIC_IDX 9
#define TELEMETRY_PPRZ_MSG_AUTOPILOT_VERSION_IDX 10
#define TELEMETRY_PPRZ_MSG_LOGGER_STATUS_IDX 11
#define TELEMETRY_PPRZ_MSG_STATE_FILTER_STATUS_IDX 12
#define TELEMETRY_PPRZ_MSG_BARO_RAW_IDX 13
#define TELEMETRY_PPRZ_MSG_IMU_MAG_IDX 14
#define TELEMETRY_PPRZ_MSG_SEGMENT_IDX 15
#define TELEMETRY_PPRZ_MSG_IMU_ACCEL_IDX 16
#define TELEMETRY_PPRZ_MSG_CAM_IDX 17
#define TELEMETRY_PPRZ_MSG_SETTINGS_IDX 18
#define TELEMETRY_PPRZ_MSG_ATTITUDE_IDX 19
#define TELEMETRY_PPRZ_MSG_RC_IDX 20
#define TELEMETRY_PPRZ_MSG_COMMANDS_IDX 21
#define TELEMETRY_PPRZ_MSG_WP_MOVED_IDX 22
#define TELEMETRY_PPRZ_MSG_ACTUATORS_IDX 23
#define TELEMETRY_PPRZ_MSG_IMU_GYRO_RAW_IDX 24
#define TELEMETRY_PPRZ_MSG_WIND_INFO_RET_IDX 25
#define TELEMETRY_PPRZ_MSG_SURVEY_IDX 26
#define TELEMETRY_PPRZ_MSG_FBW_STATUS_IDX 27
#define TELEMETRY_PPRZ_MSG_ESC_IDX 28
#define TELEMETRY_PPRZ_MSG_AIRSPEED_IDX 29
#define TELEMETRY_PPRZ_MSG_IMU_MAG_RAW_IDX 30
#define TELEMETRY_PPRZ_MSG_ESTIMATOR_IDX 31
#define TELEMETRY_PPRZ_MSG_GPS_IDX 32
#define TELEMETRY_PPRZ_MSG_ALIVE_IDX 33
...
#define TELEMETRY_PPRZ_CBS { \
  ...
  {.id=PPRZ_MSG_ID_AEROPROBE, .slots={ NULL }}, \
...
#define PERIOD_AEROPROBE_Ap_0 (0.1)
...
static inline void periodic_telemetry_send_Ap(struct periodic_telemetry *telemetry, struct transport_tx *trans, struct link_device *dev) {
  if (telemetry_mode_Ap == TELEMETRY_MODE_Ap_default) {
    ...
    static uint32_t i2 = 0; i2++; if (i2>= (uint32_t)(TELEMETRY_FREQUENCY*11.1)) i2=0;
    static uint32_t i3 = 0; i3++; if (i3>= (uint32_t)(TELEMETRY_FREQUENCY*1)) i3=0;
    static uint32_t i4 = 0; i4++; if (i4>= (uint32_t)(TELEMETRY_FREQUENCY*5.1)) i4=0;
    static uint32_t i5 = 0; i5++; if (i5>= (uint32_t)(TELEMETRY_FREQUENCY*0.25)) i5=0;
    static uint32_t i6 = 0; i6++; if (i6>= (uint32_t)(TELEMETRY_FREQUENCY*1.)) i6=0;
    ...
    uint8_t j;
    if (i13 == (uint32_t)(TELEMETRY_FREQUENCY*9.*0.500000)) {
    ...
    if (i4 == (uint32_t)(TELEMETRY_FREQUENCY*5.1*0.200000)) {
      for (j = 0; j < TELEMETRY_NB_CBS; j++) {
    ...
    if (i4 == (uint32_t)(TELEMETRY_FREQUENCY*5.1*0.900000)) {
      for (j = 0; j < TELEMETRY_NB_CBS; j++) {
    ...
    if (i4 == (uint32_t)(TELEMETRY_FREQUENCY*5.1*0.400000)) {
      for (j = 0; j < TELEMETRY_NB_CBS; j++) {
    ...
    if (i15 == (uint32_t)(TELEMETRY_FREQUENCY*5.*0.700000)) {
      for (j = 0; j < TELEMETRY_NB_CBS; j++) {
    ...
    if (i23 == (uint32_t)(TELEMETRY_FREQUENCY*5*0.800000)) {
      for (j = 0; j < TELEMETRY_NB_CBS; j++) {
    ...
    if (i14 == (uint32_t)(TELEMETRY_FREQUENCY*4.9*0.600000)) {
      for (j = 0; j < TELEMETRY_NB_CBS; j++) {
    ...
    if (i16 == (uint32_t)(TELEMETRY_FREQUENCY*2.2*0.800000)) {
      for (j = 0; j < TELEMETRY_NB_CBS; j++) {
    ...
    if (i12 == (uint32_t)(TELEMETRY_FREQUENCY*2.1*0.100000)) {
      for (j = 0; j < TELEMETRY_NB_CBS; j++) {
    ...
    if (i12 == (uint32_t)(TELEMETRY_FREQUENCY*2.1*0.400000)) {
      for (j = 0; j < TELEMETRY_NB_CBS; j++) {
    ...
    if (i18 == (uint32_t)(TELEMETRY_FREQUENCY*2.0*0.200000)) {
      for (j = 0; j < TELEMETRY_NB_CBS; j++) {
    ...
    if (i24 == (uint32_t)(TELEMETRY_FREQUENCY*2*0.900000)) {
      for (j = 0; j < TELEMETRY_NB_CBS; j++) {
    ...
    if (i2 == (uint32_t)(TELEMETRY_FREQUENCY*11.1*0.200000)) {
      for (j = 0; j < TELEMETRY_NB_CBS; j++) {
    ...
    if (i17 == (uint32_t)(TELEMETRY_FREQUENCY*1.5*0.000000)) {
      for (j = 0; j < TELEMETRY_NB_CBS; j++) {
    ...
    if (i21 == (uint32_t)(TELEMETRY_FREQUENCY*1.3*0.000000)) {
      for (j = 0; j < TELEMETRY_NB_CBS; j++) {
    ...
    if (i21 == (uint32_t)(TELEMETRY_FREQUENCY*1.3*0.500000)) {
      for (j = 0; j < TELEMETRY_NB_CBS; j++) {
    ...
    if (i11 == (uint32_t)(TELEMETRY_FREQUENCY*1.2*0.300000)) {
      for (j = 0; j < TELEMETRY_NB_CBS; j++) {
    ...
    if (i8 == (uint32_t)(TELEMETRY_FREQUENCY*1.1*0.900000)) {
      for (j = 0; j < TELEMETRY_NB_CBS; j++) {
    ...
    if (i9 == (uint32_t)(TELEMETRY_FREQUENCY*1.05*0.100000)) {
      for (j = 0; j < TELEMETRY_NB_CBS; j++) {
    ...
    if (i22 == (uint32_t)(TELEMETRY_FREQUENCY*1.0*0.700000)) {
      for (j = 0; j < TELEMETRY_NB_CBS; j++) {
    ...
    if (i6 == (uint32_t)(TELEMETRY_FREQUENCY*1.*0.600000)) {
      for (j = 0; j < TELEMETRY_NB_CBS; j++) {
    ...
    if (i3 == (uint32_t)(TELEMETRY_FREQUENCY*1*0.300000)) {
      for (j = 0; j < TELEMETRY_NB_CBS; j++) {
    ...
    if (i25 == (uint32_t)(TELEMETRY_FREQUENCY*0.9*0.100000)) {
      for (j = 0; j < TELEMETRY_NB_CBS; j++) {
    ...
    if (i7 == (uint32_t)(TELEMETRY_FREQUENCY*0.5*0.600000)) {
      for (j = 0; j < TELEMETRY_NB_CBS; j++) {
    ...
    if (i7 == (uint32_t)(TELEMETRY_FREQUENCY*0.5*0.000000)) {
      for (j = 0; j < TELEMETRY_NB_CBS; j++) {
    ...
    if (i7 == (uint32_t)(TELEMETRY_FREQUENCY*0.5*0.800000)) {
      for (j = 0; j < TELEMETRY_NB_CBS; j++) {
    ...
    if (i5 == (uint32_t)(TELEMETRY_FREQUENCY*0.25*0.500000)) {
      for (j = 0; j < TELEMETRY_NB_CBS; j++) {
    ...
    if (i10 == (uint32_t)(TELEMETRY_FREQUENCY*0.2*0.200000)) {
      for (j = 0; j < TELEMETRY_NB_CBS; j++) {
    ...
    if (i1 == (uint32_t)(TELEMETRY_FREQUENCY*0.1*0.300000)) {
      for (j = 0; j < TELEMETRY_NB_CBS; j++) {
    ...
    if (i1 == (uint32_t)(TELEMETRY_FREQUENCY*0.1*0.700000)) {
      for (j = 0; j < TELEMETRY_NB_CBS; j++) {
    ...
    if (i1 == (uint32_t)(TELEMETRY_FREQUENCY*0.1*0.100000)) {
      for (j = 0; j < TELEMETRY_NB_CBS; j++) {
        if (telemetry->cbs[TELEMETRY_PPRZ_MSG_AEROPROBE_IDX].slots[j] != NULL)
          telemetry->cbs[TELEMETRY_PPRZ_MSG_AEROPROBE_IDX].slots[j](trans, dev);
        else break;
      }
#if USE_PERIODIC_TELEMETRY_REPORT
      if (j == 0) periodic_telemetry_err_report(TELEMETRY_PROCESS_Ap, telemetry_mode_Ap, PPRZ_MSG_ID_AEROPROBE);
#endif
    }
    if (i19 == (uint32_t)(TELEMETRY_FREQUENCY*.8*0.300000)) {
      for (j = 0; j < TELEMETRY_NB_CBS; j++) {
    ...
    if (i20 == (uint32_t)(TELEMETRY_FREQUENCY*.6*0.400000)) {
      for (j = 0; j < TELEMETRY_NB_CBS; j++) {
